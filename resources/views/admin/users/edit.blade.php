    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card-header">Изменить пользователя #{{$user->id }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="/dash/users/{{ $user->id }}/update">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="role-selector" name="role[]" multiple>
                                    @foreach ($roles as $role)
                                    <option value="{{ $role->id }}" {{ $user->hasRole($role->code)? 'selected': ''}}>{{ $role->title }}</option>
                                    @endforeach
                                  </select>
                        ...
                        <div class="form-group row mb-0">
                            ...
                            <div class="col-md-3">
                            <a href="/dash/users/{{ $user->id }}/delete" class="btn btn-danger">
                                    Удалить
                                </a>
                            </div>
                        </div>
